  ...
  useAgentView(
    lesson
      ? {
          ...
          info: 'The user is taking a Collocations in Use lesson. Lesson text — read_book_unit with book=phrasebook and this number; lesson list — list_book_units book=phrasebook.',
          ids: { number: String(lesson.number) },
        }
      : { app: 'phrasebook', screen: 'lesson' },
  )
