  ...
  useAgentView(
    lesson
      ? {
          ...
          info: 'The user is taking an Essential Words lesson. Lesson text — read_book_unit with book=essentialbook and this number; lesson list — list_book_units book=essentialbook.',
          ids: { number: String(lesson.number) },
        }
      : { app: 'essentialbook', screen: 'lesson' },
  )
