...
export type { paths as OnboardingPaths, components as OnboardingComponents } from './onboarding.ts'
...
export type { paths as StudioPaths, components as StudioComponents } from './studio.ts'
