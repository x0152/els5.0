...
type Config struct {
	...
	Session  SessionConfig `envPrefix:"READER_SESSION_"`
	Bucket   string        `env:"READER_S3_BUCKET" envDefault:"books"`
	TempDir  string        `env:"READER_TEMP_DIR" envDefault:"/tmp"`
